...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="bg-[#0143b4] text-white p-4">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-4 bg-gray-50 flex space-x-4">
            <button
              ...
              className="flex-1 flex items-center justify-center py-2 px-4 rounded-md text-sm font-medium text-white bg-[#0143b4] hover:bg-[#013a9d] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0143b4]"
            >
